...
int main()
{
    ...
    Camera camera(Vector(0, 2, 0), Vector(0, 0.4, -2), Vector(0, 1, 0), 45, aspect_ratio);
    ...
    auto texture_sphere = std::make_shared<Diffuse_specular>(10, 0.8, 0.18);
    auto texture_sphere2 = std::make_shared<Diffuse_texture>(0.18);
    Sphere sphere(Object::Surface_type::diffuse_specular, texture_sphere, Vector(0, 0.4, -2), 0.4);
    Sphere sphere2(Object::Surface_type::diffuse, texture_sphere2, Vector(0.85, 0.4, -1.61), 0.4);
    ...
    Point_Light light(Vector(255, 255, 255), 150, Vector(1, 1, -1));
